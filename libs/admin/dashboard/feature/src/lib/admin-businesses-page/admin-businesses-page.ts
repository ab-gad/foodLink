...
@Component({
  selector: 'lib-admin-businesses-page',
...
export class AdminBusinessesPage {
  ...
  protected readonly usersQuery = injectQuery(() => this.dashboardService.getAllBusinessesOptions());
  ...
  protected readonly columns: ColumnDef<AdminBusinessResponse>[] = [
    {
      id: 'Avatar',
      accessorKey: 'profileImage',
      header: 'Avatar',
      enableSorting: false,
      cell: (context) => flexRenderComponent(UserAvatar, { inputs: { image: context.row.original.profileImage, fallbackText: context.row.original.businessName } }),
    },
    {
      id: 'Name',
      accessorKey: 'businessName',
      header: () =>
        flexRenderComponent(TableHeadSortButton<AdminBusinessResponse>, { inputs: { header: '' } }),
    ...
    },
    {
      ...
      enableHiding: false,
      cell: (context) =>
        flexRenderComponent(ActionDropdown<AdminBusinessResponse>, {
          inputs: {
  ...
  protected readonly table: Table<AdminBusinessResponse> = createAngularTable(
    () => ({
  ...
  private viewProfile(business: AdminBusinessResponse): void {
    this.router.navigate(['/businesses', business.id], {
      state: { title: `${business.businessName} | Profile`, business },
    });
  }
}
